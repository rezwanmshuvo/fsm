...
var InputsCheckboxesRadios = function() {
    ...
    var _componentUniform = function() {
        ...
        $('.form-check-input-styled-success').uniform({
            wrapperClass: 'custom-border-success custom-text-success'
        });
    ...
    var _componentSwitchery = function() {
        ...
        // Colored switches
        var primary = Array.prototype.slice.call(document.querySelectorAll('.form-check-input-switchery-primary'));
        primary.forEach(function(html) {
            var switchery = new Switchery(html, { color: '#558b2f' });
        });
