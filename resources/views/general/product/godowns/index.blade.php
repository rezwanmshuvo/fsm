    ...
    <div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
        <div class="d-flex">
            <div class="breadcrumb">
                ...
                <span class="breadcrumb-item active">Godowns</span>
            </div>
        </div>
    </div>
</div>
...
<div class="content">
    ...
    <div class="card">
        <div class="card-header header-elements-inline">
            <h5 class="card-title">Godowns</h5>
            <div class="header-elements">
                <a type="button" href="" class="btn custom-btn-success" data-toggle="modal" data-target="#create_modal"><i class="icon-plus3 mr-2"></i>Add Godown</a>
            </div>
        </div>
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">New Godown</h5>
                    ...
                    <div class="card-body">
                        <form action="#">
                            <div class="form-group row">
                                <label class="col-form-label col-lg-2">Godown Name</label>
                                <div class="col-lg-10">
