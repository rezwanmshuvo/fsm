    ...
    <div class="card">
        <div class="card-header header-elements-inline">
            ...
            <div class="header-elements">
                <a type="button" href="" class="btn custom-btn-success" data-toggle="modal" data-target="#create_modal"><i class="icon-plus3 mr-2"></i>Add Vehicle</a>
            </div>
        </div>
                    ...
                    <div class="card-body">
                        <form action="#">
                            <div class="form-group row">
                                <label class="col-form-label col-lg-2">Vehicle Name</label>
                                <div class="col-lg-10">
