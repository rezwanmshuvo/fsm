    ...
    <div class="card">
        <div class="card-header header-elements-inline">
            ...
            <div class="header-elements">
                <a type="button" href="" class="btn custom-btn-success" data-toggle="modal" data-target="#create_modal"><i class="icon-plus3 mr-2"></i>Add Item Category</a>
            </div>
        </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-10">
                                    <select name="active_status" class="form-control select-search">
                                        <option value="">Selelct Parent Category</option>
