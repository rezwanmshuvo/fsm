    ...
    <div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
        <div class="d-flex">
            <div class="breadcrumb">
                ...
                <span class="breadcrumb-item active">Deposit Report</span>
            </div>
        </div>
    </div>
</div>
...
<div class="content">
    ...
    <div class="card hide-filter-on-print">
        ...
        <div class="card-body">
            ...
            <form action="{{ route('reports.deposit') }}" method="get" id="get_form">
                @csrf
                    ...
                    <div class="" id="get_table_data">
                        <table class="table table-bordered table-striped table_data" id="table_data">
                            ...
                            <tbody>
                                ...
                                @endforeach
                                <tr>
                                    <td colspan="5" class="text-right font-weight-bolder">Total Deposit</td>
                                    <td class="font-weight-bold" id="tot4">{{ $totalDeposit }}</td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
...
@push('js')
    ...
    <script>
        ...
        let customer = document.getElementById("select-customers").value;
        ...
        if (customer.length) {
            href += "filter[customer_id]=" + customer;
        }
