    ...
    <div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
        <div class="d-flex">
            <div class="breadcrumb">
                ...
                <span class="breadcrumb-item active">New Purpose</span>
            </div>
        </div>
    </div>
</div>
...
<div class="content">
    ...
    <div class="card">
        <div class="card-header header-elements-inline">
            <h5 class="card-title">New Purpose</h5>
        ...
        <div class="card-body">
            <form action="{{ route('purpose.store') }}" method="POST">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-10">
                        <input type="text" name="name" class="form-control @error('name') is-invalid @enderror" placeholder="Purpose" value="{{ old('name') }}">
                        @error('name')
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-10">
                        <select name="purpose_type" class="form-control select-search @error('purpose_type') is-invalid @enderror">
                            ...
                            <option value="income" {{ (old('purpose_type') == 'income') ? 'selected=selected' : ''}}>Income</option>
                            <option value="expanse" {{ (old('purpose_type') == 'expanse') ? 'selected=selected' : ''}}>Expanse</option>
                        </select>
                        @error('purpose_type')
                            <div class="text-danger">{{ $message }}</div>
                        @enderror
