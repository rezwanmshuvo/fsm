    ...
    <div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
        <div class="d-flex">
            <div class="breadcrumb">
                ...
                <span class="breadcrumb-item active">{{ $bank->bank_name }}</span>
            </div>
        </div>
    </div>
</div>
        ...
        <div class="card-body">
            <form action="{{ route('bank.update', $bank->id) }}" method="POST">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-10">
                        <input type="text" name="bank_name" class="form-control @error('bank_name') is-invalid @enderror" placeholder="Bank Name" value="{{ old('bank_name', $bank->bank_name) }}">
                        @error('bank_name')
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-10">
                        <input type="text" name="bank_branch" class="form-control" placeholder="Bank Branch" value="{{ old('bank_branch', $bank->bank_branch) }}">
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-10">
                        <input type="text" name="account_name" class="form-control" placeholder="Account Holder" value="{{ old('account_name', $bank->account_name) }}">
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-10">
                        <input type="text" name="account_number" class="form-control" placeholder="Account Number" value="{{ old('account_number', $bank->account_number) }}">
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-10">
                        <div class="input-group">
                            ...
                            <input type="text" name="opening_balance" class="form-control @error('opening_balance') is-invalid @enderror" placeholder="Opening Balance" value="{{ old('opening_balance', $bank->opening_balance) }}">
                        </div>
