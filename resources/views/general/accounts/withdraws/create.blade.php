    ...
    <div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
        <div class="d-flex">
            <div class="breadcrumb">
                ...
                <span class="breadcrumb-item active">New Withdraw</span>
            </div>
        </div>
    </div>
</div>
...
<div class="content">
    ...
    <div class="card">
        <div class="card-header header-elements-inline">
            <h5 class="card-title">New Withdraw</h5>
                    ...
                    <div class="col-lg-10">
                        <select name="party_id" class="form-control select-search">
                            ...
                            @foreach($suppliers as $supplier)
                                <option value="{{ $supplier->id }}" {{ (old('party_id')== $supplier->id) ? 'selected=selected': ''}}>{{ $supplier->name }}</option>
                            @endforeach
                        </select>
                    </div>
                </div>
