                            ...
                            <tr>
                                <td>
                                    ...
                                    <span style="dispaly:block;">
                                        {{ date('d-m-Y g:i:s A', strtotime($withdraw->withdraw_date)) }}
                                    </span>
                                </td>
                        ...
                        <table class="table table-bordered" style="border-color: #595959; width:100%;">
                            <tbody>
                                <tr>
                                    ...
                                    <td colspan="4">
                                        {{ (!is_null($withdraw->party)) ? $withdraw->party->name : 'Not set' }}
                                    </td>
                                </tr>
