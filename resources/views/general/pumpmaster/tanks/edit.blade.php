    ...
    <div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
        <div class="d-flex">
            <div class="breadcrumb">
                ...
                <span class="breadcrumb-item active">{{ $tank->name }}</span>
            </div>
        </div>
    </div>
</div>
        ...
        <div class="card-body">
            <form action="{{ route('tank.update', $tank->id) }}" method="POST">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-10">
                        <input type="text" name="name" class="form-control @error('name') is-invalid @enderror" placeholder="Tank Name" value="{{ old('name', $tank->name) }}">
                        @error('name')
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-10">
                        <div class="input-group">
                            <input type="number" name="capacity" class="form-control @error('capacity') is-invalid @enderror" placeholder="Capacity" value="{{ old('capacity', $tank->capacity) }}">
                            @error('capacity')
                            <div class="text-danger">{{ $message }}</div>
                            @enderror
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-10">
                        <div class="input-group">
                            <input type="number" name="dip_min" class="form-control" placeholder="Minimum Dip" value="{{ old('dip_min', $tank->dip_min) }}">
                            @error('dip_min')
                            <div class="text-danger">{{ $message }}</div>
                            @enderror
                            <span class="input-group-prepend">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-10">
                        <div class="input-group">
                            <input type="number" name="dip_max" class="form-control" placeholder="Maximum Dip" value="{{ old('dip_max', $tank->dip_max) }}">
                            @error('dip_max')
                            <div class="text-danger">{{ $message }}</div>
                            @enderror
                            <span class="input-group-prepend">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-10">
                        ...
                        <div class="input-group">
                            <input type="number" name="dip_in_mm" class="form-control @error('dip_in_mm') is-invalid @enderror" placeholder="Dip Difereance" value="{{ old('dip_in_mm', $tank->dip_in_mm) }}">
                            @error('dip_in_mm')
                            <div class="text-danger">{{ $message }}</div>
                            @enderror
                            <span class="input-group-prepend">
