    ...
    <div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
        <div class="d-flex">
            <div class="breadcrumb">
                ...
                <span class="breadcrumb-item active">New Nozzle</span>
            </div>
        </div>
    </div>
</div>
...
<div class="content">
    ...
    <div class="card">
        <div class="card-header header-elements-inline">
            <h5 class="card-title">New Nozzle</h5>
        ...
        <div class="card-body">
            <form action="{{ route('nozzle.store') }}" method="POST">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-10">
                        <input type="text" name="name" class="form-control @error('name') is-invalid @enderror" placeholder="Nozzle Name" value="{{ old('name') }}">
                        @error('name')
                    ...
                    <div class="col-lg-10">
                        <select name="machine_id" class="form-control select-search @error('machine_id') is-invalid @enderror">
                            ...
                            @foreach($machines as $machine)
                                <option value="{{ $machine->id }}" {{ (old('machine_id')== $machine->id) ? 'selected=selected': ''}}>{{ $machine->name }}</option>
                            @endforeach
                        </select>
                        @error('machine_id')
                            <div class="text-danger">{{ $message }}</div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-10">
                        <input type="number" name="start_reading" class="form-control" placeholder="Start Reading" value="{{ old('start_reading') }}">
                        @error('start_reading')
                            <div class="text-danger">{{ $message }}</div>
                        @enderror
                    </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-10">
                        <input type="number" name="current_reading" class="form-control" placeholder="Current Reading" value="{{ old('current_reading') }}">
