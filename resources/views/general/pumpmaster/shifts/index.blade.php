    ...
    <div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
        <div class="d-flex">
            <div class="breadcrumb">
                ...
                <span class="breadcrumb-item active">Shifts</span>
            </div>
        </div>
    </div>
</div>
    ...
    <div class="card">
        <div class="card-header header-elements-inline">
            ...
            <div class="header-elements">
                <a type="button" href="{{ route('shift.create') }}" class="btn custom-btn-success"><i class="icon-plus3 mr-2"></i>Add Shifts</a>
            </div>
        </div>
