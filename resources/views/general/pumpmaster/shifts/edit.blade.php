    ...
    <div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
        <div class="d-flex">
            <div class="breadcrumb">
                ...
                <span class="breadcrumb-item active">{{ $shift->name }}</span>
            </div>
        </div>
    </div>
</div>
        ...
        <div class="card-body">
            <form action="{{ route('shift.update', $shift->id) }}" method="POST">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-10">
                        <input type="text" name="name" class="form-control @error('name') is-invalid @enderror" placeholder="Shift Name" value="{{ old('name', $shift->name) }}">
                        @error('name')
                ...
                <div class="form-group row">
                    <label class="col-form-label col-lg-2 text-mandatory">Start Time</label>
                    <div class="col-lg-10">
                        <input type="time" name="start_time" class="form-control @error('start_time') is-invalid @enderror" placeholder="Start Time" value="{{ old('start_time', $shift->start_time) }}">
                        @error('start_time')
                            <div class="text-danger">{{ $message }}</div>
                        @enderror
                    </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-10">
                        <input type="time" name="end_time" class="form-control" placeholder="End Time" value="{{ old('end_time', $shift->end_time) }}">
                    </div>
                </div>
