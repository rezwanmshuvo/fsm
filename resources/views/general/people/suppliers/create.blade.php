    ...
    <div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
        <div class="d-flex">
            <div class="breadcrumb">
                ...
                <span class="breadcrumb-item active">New Supplier</span>
            </div>
        </div>
    </div>
</div>
        ...
        <div class="card-body">
            <form action="{{ route('supplier.store') }}" method="POST">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-10">
                        <input type="text" name="name" class="form-control @error('name') is-invalid @enderror" placeholder="Supplier Name" value="{{ old('name') }}">
                        @error('name')
